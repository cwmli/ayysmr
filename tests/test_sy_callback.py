...
from tests.fixtures.sy import mock_get_access_token, mock_get_user_profile, mock_get_db
...
def test_no_state_sy_callback(client):
...
def test_invalid_state_sy_callback(client):
...
def test_no_token_sy_callback(client):
...
def test_tokens_set_sy_callback(client, mock_get_access_token, mock_get_user_profile, mock_get_db):
