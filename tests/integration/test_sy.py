...
def test_new_user_sy_callback(client, mock_get_access_token, celery, monkeypatch):
...
def test_returning_user_sy_callback(client, mock_get_access_token, monkeypatch):
